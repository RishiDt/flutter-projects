...
class RemoveMovieFromFavorite extends UseCase<void, MovieParams> {
  final MovieRepository movieRepository;

  RemoveMovieFromFavorite(this.movieRepository);
  ...
  Future<Either<AppErr, void>> call(MovieParams movieParams) async {
    ...
    final moviesEither =
        await movieRepository.removeMovieFromFavorite(movieParams.id);
